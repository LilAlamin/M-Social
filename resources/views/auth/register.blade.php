...
<head>
    ...
    <title>Daftar Akun M-Social</title>
                ...
                <div class="card p-2">
                    ...
                    <div class="app-brand justify-content-center mt-5">
                        <a href="index.html" class="app-brand-link gap-2">
                            ...
                            <span class="app-brand-text demo text-heading fw-semibold">M-Social</span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    <div class="card-body mt-2">
                        <h4 class="mb-2">Silahkan Daftar Akun Anda</h4>
                        <p class="mb-4">Daftar akun guna mengakses M-Social</p>
